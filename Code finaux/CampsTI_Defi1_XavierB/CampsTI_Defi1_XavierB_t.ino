...
// Xavier
#define POT_SHOULDER_PIN 0
#define POT_BASE_PIN 1
#define POT_ELBOW_PIN 4
#define SERVO_SHOULDER_PIN 
#define SERVO_BASE_PIN
#define SERVO_ELBOW_PIN
...
void loop() {
  ...
  int pot1Value = analogRead(POT_SHOULDER_PIN);
